    ...
    <div class="flex justify-between items-center flex-col md:flex-row">
        ...
        <div :class="{'hidden': !open}" class="leading-relaxed md:flex justify-between w-full items-center">
            <div class="flex md:items-center flex-col md:flex-row border-b border-gray-200 md:border-b-0 py-2 md:py-0">
                ...
                <a href="#" class="block text-gray-300 hover:text-white px-4 md:py-4 flex items-center">
                    <div class=""><svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path
                ...
                <a href="#" class="block text-gray-300 hover:text-white px-4 md:py-4 flex items-center">
                    <div><svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
            ...
            <div class="flex md:items-center flex-col md:flex-row">
                ...
                <div x-data="{ dropdownIsOpen: false }">
                    ...
                    <div :class="{ 'hidden': !dropdownIsOpen }"
                        class="md:absolute md:top-0 md:right-0 md:mr-4 md:mt-14 md:bg-gray-800 md:w-56 md:rounded md:shadow py-1 mb-2 md:mb-0 md:py-3">
                        <a href="" class="block text-gray-300 hover:text-white px-4 md:ml-0 ml-12">Profile</a>
                        <a href="{{ route('account.edit') }}" class="block text-gray-300 hover:text-white px-4 md:ml-0 ml-12">Setting</a>
                        <a href="{{ route('logout') }}"
